    ...
    <div className="z-20 flex items-start mb-1">
      ...
      {editMode && !isComplete ? (
        <p
          ...
          contentEditable
          suppressContentEditableWarning={true}
          className="z-20 font-sans text-lg font-bold bg-white outline outline-offset-1 rounded outline-neutral-300 dark:bg-neutral-800/50 dark:outline-neutral-500"
        >
          {task.title}
        </p>
      ) : (

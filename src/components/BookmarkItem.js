      ...
      <div className="mb-2 flex items-start">
        {editMode ? (
          <span
            ...
            className="... z-20 truncate break-words bg-white font-sans text-lg rounded font-bold leading-6 outline outline-offset-1 outline-neutral-300 dark:bg-neutral-800/50 dark:outline-neutral-500"
          >
            <a
      ...
      <div className="flex">
        {editMode ? (
          <p
            ...
            suppressContentEditableWarning={true}
            id="bookmark-url"
            className="... mt-1 truncate bg-white leading-6 text-neutral-500 rounded outline outline-offset-1 outline-neutral-300 dark:bg-neutral-800/50 dark:text-neutral-400 dark:outline-neutral-500"
          >
            {bookmark.content}
          </p>
        ) : (

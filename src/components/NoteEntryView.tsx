          ...
          <div className="group relative mt-12">
            ...
            {editMode ? (
              <p
                ...
                className="mt-2 mb-8 py-[3.5px] text-3xl font-bold leading-8 rounded tracking-tight outline outline-offset-1 outline-neutral-300 ring-neutral-600 sm:text-5xl dark:outline-neutral-500"
              >
                {entry[0].title}
              </p>
            ) : (
            ...
            {editMode ? (
              <>
                ...
                <p
                  ...
                  contentEditable
                  suppressContentEditableWarning={true}
                  className="mt-2 text-lg text-neutral-500 rounded outline outline-offset-1 outline-neutral-300 ring-neutral-600 dark:text-neutral-400 dark:outline-neutral-500"
                >
                  {entry[0].content}
                </p>
              </>
